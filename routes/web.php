...
Route::get('/inventaris',[DatabarangController::class,'index'])->name('inventaris');

Route::get('/tambahinventaris',[DatabarangController::class,'tambahinventaris'])->name('tambahinventaris');
